...
### 2.1. Cải thiện logic kiểm tra dịch vụ ở Kiosk khi đăng ký tái khám (SAKURA-95900)

- Loại cập nhật: Cải tiến
- Lý do thực hiện và giá trị mang lại: Bảo đảm luồng tái khám tại Kiosk kiểm tra đúng dịch vụ và đúng thời điểm tái khám trước khi in phiếu. Giá trị mang lại: Giảm trường hợp Người bệnh đến trễ hoặc đến sớm nhưng vẫn in phiếu dịch vụ không phù hợp.
- Mục đích thay đổi: Chỉ cho phép in và tiếp tục luồng tái khám khi dịch vụ nằm trong khoảng ngày hợp lệ theo thiết lập.
- Nội dung cập nhật:
  + Hiện tại: Khi quét mã Người bệnh tại Kiosk, hệ thống chưa luôn kiểm tra đúng khoảng ngày tái khám trước khi chuyển sang in phiếu dịch vụ.
  + Sau khi cập nhật: Hệ thống kiểm tra theo thiết lập ngày tái khám; nếu không thỏa điều kiện thì xử lý như luồng lấy số tiếp đón hiện tại, nếu thỏa điều kiện thì in đúng phiếu dịch vụ cần dùng.
- Tác động tới người dùng: Nhân viên Tiếp đón và Người bệnh tái khám sẽ đi đúng luồng hơn khi thao tác tại Kiosk.
- Ảnh hưởng thay đổi: Ảnh hưởng tới màn hình Kiosk đăng ký tái khám, logic kiểm tra dịch vụ tái khám và luồng in phiếu dịch vụ.
- Hướng dẫn sử dụng: Người dùng cần kiểm tra lại ngày tái khám và thiết lập liên quan trước khi thao tác tại Kiosk.
- Thông tin tham chiếu: Loại: Cải tiến | Trạng thái: Passed Stable | Phân hệ: Tiếp đón, KIOSK Tiếp đón | Phiên bản: Đẩy code 12/05/2026_HIS_SAKURA

### 2.2. Bắt buộc chọn phòng khi chỉ định dịch vụ ở Tiếp đón (SAKURA-96573)

- Loại cập nhật: Tính năng mới
- Lý do thực hiện và giá trị mang lại: Bảo đảm Lễ tân biết Người bệnh sẽ vào phòng nào để hướng dẫn đúng và in phiếu chỉ định đúng phòng.
- Mục đích thay đổi: Bắt buộc người dùng chọn phòng thực hiện trước khi lưu chỉ định dịch vụ ở màn hình Tiếp đón.
- Nội dung cập nhật:
  + Hiện tại: Chưa bắt chọn phòng thực hiện khi kê dịch vụ ở Tiếp đón.
  + Sau khi cập nhật: Bắt buộc chọn phòng khi chỉ định dịch vụ ở Tiếp đón, hiển thị dấu `*` ở trường Phòng và cảnh báo `Vui lòng chọn phòng thực hiện` nếu chưa chọn.
- Tác động tới người dùng: Nhân viên Tiếp đón phải chọn đúng phòng trước khi lưu chỉ định dịch vụ.
- Ảnh hưởng thay đổi: Ảnh hưởng tới màn hình Tiếp đón, trường Phòng thực hiện và phiếu chỉ định dịch vụ in ra.
- Hướng dẫn sử dụng: Người dùng cần chọn phòng thực hiện trước khi bấm lưu chỉ định dịch vụ.
- Thông tin tham chiếu: Loại: Tính năng | Trạng thái: Passed Stable | Phân hệ: Tiếp đón | Phiên bản: Đẩy code 14/05/2026_HIS_SAKURA

### 2.3. Bổ sung phương tiện cấp cứu trong popup thông tin cấp cứu (SAKURA-96387)

- Loại cập nhật: Cải tiến
- Lý do thực hiện và giá trị mang lại: Bổ sung dữ liệu để thống kê Người bệnh vào giao ban Nội khoa chính xác hơn.
- Mục đích thay đổi: Lưu thêm phương tiện đưa Người bệnh đến viện trong thông tin cấp cứu.
- Nội dung cập nhật:
  + Hiện tại: Chưa có trường Phương tiện cấp cứu.
  + Sau khi cập nhật: Thêm trường Phương tiện cấp cứu với các giá trị `115 đưa đến`, `Phương tiện cá nhân`, `Cấp cứu ngoại viện đón NB về viện`, `Cấp cứu ngoại viện đưa NB đi viện khác`.
- Thêm trường:
  + Phương tiện cấp cứu
- Tác động tới người dùng: Nhân viên Tiếp đón khai báo được thêm thông tin cấp cứu ngay tại pop-up.
- Ảnh hưởng thay đổi: Ảnh hưởng tới popup Thông tin cấp cứu và dữ liệu thống kê giao ban.
- Hướng dẫn sử dụng: Người dùng chọn đúng phương tiện cấp cứu khi bật checkbox Cấp cứu.
- Thông tin tham chiếu: Loại: Cải tiến | Trạng thái: Passed Stable | Phân hệ: Tiếp đón | Phiên bản: Đẩy code 14/05/2026_HIS_SAKURA

### 2.4. Sửa lỗi không truyền khoa chỉ định khi tiếp đón cận lâm sàng tương lai (SAKURA-96410)

- Loại cập nhật: Hot-fix
- Lý do thực hiện và giá trị mang lại: Tránh lỗi thiếu khoa chỉ định khi bấm Người bệnh tiếp theo trong luồng tiếp đón cận lâm sàng tương lai.
- Mục đích thay đổi: Truyền đúng khoa chỉ định khi tiếp đón dịch vụ cận lâm sàng tương lai.
- Nội dung cập nhật:
  + Hiện tại: Khi tiếp đón cận lâm sàng tương lai, bấm `NB tiếp theo` thì FE không truyền `khoaChiDinhId`.
  + Sau khi cập nhật: Hệ thống truyền đúng `khoaChiDinhId` để không còn lỗi thiếu khoa chỉ định.
- Tác động tới người dùng: Nhân viên Tiếp đón không còn gặp lỗi thiếu khoa chỉ định khi đi tiếp luồng cận lâm sàng tương lai.
- Ảnh hưởng thay đổi: Ảnh hưởng tới luồng tiếp đón cận lâm sàng tương lai và các API chỉ định dịch vụ liên quan.
- Hướng dẫn sử dụng: Người dùng thao tác tiếp đón như bình thường, hệ thống sẽ tự truyền khoa chỉ định.
- Thông tin tham chiếu: Loại: Hot-fix | Trạng thái: Passed Stable | Phân hệ: Tiếp đón | Phiên bản: Đẩy code 14/05/2026_HIS_SAKURA

### 2.5. Sửa lỗi lưu báo loại đối tượng không đúng yêu cầu (SAKURA-96426)

- Loại cập nhật: Lỗi
- Lý do thực hiện và giá trị mang lại: Đảm bảo dữ liệu loại đối tượng được lưu đúng khi chỉnh sửa Người bệnh đang được báo loại đối tượng.
- Mục đích thay đổi: Sửa lỗi lưu báo loại đối tượng không đúng yêu cầu.
- Nội dung cập nhật:
  + Hiện tại: Khi vào chỉnh sửa Người bệnh đang báo lỗi loại đối tượng thì hệ thống lưu không đúng mong muốn.
  + Sau khi cập nhật: Lưu báo loại đối tượng đúng theo yêu cầu khi chỉnh sửa hồ sơ.
- Tác động tới người dùng: Nhân viên Tiếp đón chỉnh sửa hồ sơ Người bệnh ổn định hơn.
- Ảnh hưởng thay đổi: Ảnh hưởng tới luồng sửa hồ sơ Người bệnh và dữ liệu loại đối tượng.
- Hướng dẫn sử dụng: Người dùng kiểm tra lại loại đối tượng sau khi lưu chỉnh sửa.
- Thông tin tham chiếu: Loại: Lỗi | Trạng thái: Passed Stable | Phân hệ: Tiếp đón | Phiên bản: Đẩy code 12/05/2026_HIS_SAKURA
